...
Format your responses clearly with headers and bullet points."""
    ...
    async def process_async(self, query: str) -> str:
        """
        Process a user query about their discharge summary (Async).
        """
...
Please ensure this is a discharge summary document."""
...
## Response:"""
    ...
    def get_summary(self) -> str:
        """Get a comprehensive summary of the discharge document."""
...
## Summary:"""
    ...
    def extract_medications(self) -> str:
        ...
        if not results:
            return "No medication information found in this document."
